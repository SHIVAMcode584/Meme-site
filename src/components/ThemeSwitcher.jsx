  ...
  return (
    <div ref={rootRef} className="relative shrink-0">
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-full border border-[color:var(--app-border)] bg-[color:var(--app-surface)] px-2.5 py-1.5 text-[11px] font-semibold text-[color:var(--app-text)] transition hover:bg-[color:var(--app-surface-2)] sm:gap-2 sm:px-4 sm:py-2 sm:text-xs"
      ...
      {isOpen ? (
        <div
          className="absolute right-0 top-[calc(100%+0.75rem)] z-[220] w-[min(18rem,calc(100vw-1.5rem))] overflow-hidden rounded-[1.5rem] border border-[color:var(--app-border)] bg-[color:var(--app-surface)] shadow-[0_24px_70px_var(--app-glow)] backdrop-blur-xl"
          role="menu"
            ...
            <div className="grid gap-2">
              {themeOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="h-10 w-10 shrink-0 rounded-xl border border-[color:var(--app-border)] shadow-inner"
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="mt-0.5 block text-xs leading-5 text-[color:var(--app-muted)]">
                        {option.description}
                      </span>
                    </span>
                  </button>
